        ...
        <div className="mx-auto grid w-full max-w-7xl gap-6 rounded-lg border border-white/10 bg-[#07101d]/85 p-6 shadow-[0_20px_70px_rgba(0,0,0,.24)] lg:grid-cols-[0.85fr_1.15fr] lg:p-8">
          ...
          >
            ...
            <div className="grid gap-4 sm:grid-cols-2">
              <input name="name" required className="rounded-lg border border-white/10 bg-[#030712] px-4 py-3 text-sm text-white outline-none transition placeholder:text-slate-600 focus:border-blue-400" placeholder="Your name" />
              <input name="business" required className="rounded-lg border border-white/10 bg-[#030712] px-4 py-3 text-sm text-white outline-none transition placeholder:text-slate-600 focus:border-blue-400" placeholder="Business name" />
            </div>
            <div className="grid gap-4 sm:grid-cols-2">
              <input name="email" type="email" required className="rounded-lg border border-white/10 bg-[#030712] px-4 py-3 text-sm text-white outline-none transition placeholder:text-slate-600 focus:border-blue-400" placeholder="Work email" />
              <select name="channel" required className="rounded-lg border border-white/10 bg-[#030712] px-4 py-3 text-sm text-white outline-none transition focus:border-blue-400" defaultValue="">
            ...
            <div className="grid gap-4 sm:grid-cols-[220px_1fr]">
              <select name="country_code" required className="rounded-lg border border-white/10 bg-[#030712] px-4 py-3 text-sm text-white outline-none transition focus:border-blue-400" defaultValue="+91">
            ...
            <textarea name="requirement" required rows={4} className="resize-none rounded-lg border border-white/10 bg-[#030712] px-4 py-3 text-sm text-white outline-none transition placeholder:text-slate-600 focus:border-blue-400" placeholder="What do you want to automate?" />
