...
const useCases = [
  ...
  },
  {
    ...
    text: "Collect customer details, understand intent, and separate serious leads from casual enquiries.",
    detail: "Useful for service providers, stores, agencies, educators, consultants, and local businesses that need clean lead data before follow-up.",
  },
  {
    Icon: HiOutlineBolt,
...
function getFooterHref(link: string) {
  ...
  if (["Multi-Channel Inbox", "Lead Capture", "Sales Follow-up", "Customer Support"].includes(link)) return "#solutions";
  return "#";
}
            ...
            {useCases.map(({ Icon, title, text, detail }) => (
              ...
              >
                ...
                <div className="mt-5 flex flex-wrap gap-3">
                  ...
                  <a href={leadFormLink} onClick={(event) => { event.stopPropagation(); trackCta("solution_book_demo", title.toLowerCase().replaceAll(" ", "_"), "demo_click"); }} className="text-sm font-bold text-violet-200 transition hover:text-white">
                    Book Demo
                  </a>
                </div>
              </article>
        ...
        <div className="mx-auto w-full max-w-7xl">
          <div className="grid gap-8 md:grid-cols-2 lg:grid-cols-[1.3fr_0.8fr_0.8fr_0.8fr_0.8fr_1.4fr]">
            ...
            {[
              ...
              { title: "Solutions", links: ["Multi-Channel Inbox", "Lead Capture", "Sales Follow-up", "Customer Support"] },
