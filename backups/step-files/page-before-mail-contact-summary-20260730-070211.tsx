...
export default function Home() {
  ...
  return (
    ...
    >
      ...
      <section id="home" className="relative flex min-h-[780px] scroll-mt-28 items-center overflow-hidden px-4 pb-10 pt-36 sm:min-h-screen sm:pt-52 lg:pt-40">
      ...
      <section id="lead-form" className="px-4 pb-12 pt-2 sm:pb-16">
        <div className="mx-auto grid w-full max-w-7xl gap-6 rounded-lg border border-white/10 bg-[#07101d]/85 p-6 shadow-[0_20px_70px_rgba(0,0,0,.24)] lg:grid-cols-[0.85fr_1.15fr] lg:p-8">
          ...
          >
            ...
            <div className="grid gap-4 sm:grid-cols-2">
              <input name="Work Email" type="email" required className="rounded-lg border border-white/10 bg-[#030712] px-4 py-3 text-sm text-white outline-none transition placeholder:text-slate-600 focus:border-blue-400" placeholder="Work email" />
            ...
            <div className="grid gap-4 sm:grid-cols-[220px_1fr]">
              <select name="Country Code" required className="rounded-lg border border-white/10 bg-[#030712] px-4 py-3 text-sm text-white outline-none transition focus:border-blue-400" defaultValue="+91">
